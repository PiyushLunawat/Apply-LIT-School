...
export default function LitmusTestTab({
  student,
  onSelectTab,
}: LitmusTestTabProps) {
        ...
        {litmusTestDetails?.scholarshipDetail && (
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-2 border rounded-xl p-6">
            <div className="flex gap-2.5 items-center">
              <img
                src="/assets/icons/fee-wavier-icon.svg"
                className="w-12 h-8"
              />
              <div className="text-xl font-semibold">
                {litmusTestDetails?.scholarshipDetail?.scholarshipPercentage}%
                Waiver availed on the program fee
              </div>
            </div>
              ...
              (criteria: any, index: number) => (
                ...
                >
                  ...
                  <div className="text-2xl font-semibold">
                    {litmusTestDetails?.results?.[0]?.score?.[index]?.score}/
                    {
