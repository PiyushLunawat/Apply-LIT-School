    ...
    <div className="space-y-6">
        ...
        <Card className="mx-auto px-8 py-6 flex flex-col sm:flex-row gap-3 justify-between items-center">
          <div className="flex gap-2 items-center">
            ...
            <span className="flex-1">
              Proceed to reschedule your presentation session with our program
              team.
            </span>
          </div>
          <Button
      ...
      {litmusTestDetails?.litmusTestInterviews
        ...
        .map((interview: any, index: any) => (
          <Card
            key={index}
            className={`mx-auto md:flex md:flex-row rounded-2xl sm:rounded-3xl ${
              interview?.meetingStatus === "cancelled"
                ? "border-[#FF503D66] opacity-50 min-h-[680px]"
                : index === 0
                ? "min-h-[680px]"
