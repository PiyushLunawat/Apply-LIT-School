    ...
    <>
      <div className="py-8 sm:py-[52px] px-[52px] bg-[#3698FB1A] border-b space-y-4 sm:space-y-8">
        <div className="flex items-center gap-4 mb-2">
          <Badge className="text-sm border-[#3698FB] text-[#3698FB] bg-[#3698FB]/10 truncate">
            LITMUS Task
          </Badge>
        ...
        <div className="flex lg:flex-row flex-col gap-2 justify-between items-start lg:items-end">
          ...
          <p className="max-w-[360px] w-full text-sm sm:text-base ">
            Complete your LITMUS test prior to deadline to avail a scholarship
            on your fee. This scholarship will be applicable on the last
            semester fee instalments.
          </p>
        </div>
      </div>
