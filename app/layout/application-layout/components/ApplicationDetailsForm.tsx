...
const ApplicationDetailsForm: React.FC = () => {
  ...
  const { initializeRecaptcha, sendOTP, clearRecaptcha, isReady } = useFirebaseAuth()
  ...
  useEffect(() => {
    ...
    const matching = openCohorts.filter((cohort) => cohort.programDetail === selectedProgram)
        ...
        try {
          ...
          setApplicationFees(
            fetchedStudentData?.appliedCohorts?.[fetchedStudentData?.appliedCohorts.length - 1]?.cohortId
              ?.cohortFeesDetail?.applicationFee,
          )
          ...
          if (isExistingDataEmpty) {
            ...
            mergedForm = {
              studentData: {
                ...
                courseOfInterest:
                  studentData?.appliedCohorts[studentData?.appliedCohorts.length - 1]?.cohortId?.programDetail?._id ||
                  "",
            ...
            mergedForm = {
              studentData: {
                ...
                cohort:
                  ...
                  studentData?.appliedCohorts[studentData?.appliedCohorts.length - 1]?.cohortId._id ||
                  "",
                isMobileVerified: student?.isMobileVerified || false,
              ...
              applicationData: {
                ...
                educationLevel: existingData?.applicationData?.educationLevel || "",
                fieldOfStudy: existingData?.applicationData?.fieldOfStudy || "",
                institutionName: existingData?.applicationData?.institutionName || "",
                graduationYear: existingData?.applicationData?.graduationYear || "",
                isExperienced:
                ...
                fatherFirstName: existingData?.applicationData?.fatherFirstName || "",
                fatherLastName: existingData?.applicationData?.fatherLastName || "",
                fatherContact: existingData?.applicationData?.fatherContact || "",
                fatherOccupation: existingData?.applicationData?.fatherOccupation || "",
                fatherEmail: existingData?.applicationData?.fatherEmail || "",
                motherFirstName: existingData?.applicationData?.motherFirstName || "",
                motherLastName: existingData?.applicationData?.motherLastName || "",
                motherContact: existingData?.applicationData?.motherContact || "",
                motherOccupation: existingData?.applicationData?.motherOccupation || "",
                motherEmail: existingData?.applicationData?.motherEmail || "",
                financiallyDependent: existingData?.applicationData?.financiallyDependent || false,
                appliedForFinancialAid: existingData?.applicationData?.appliedForFinancialAid || false,
              },
            }
          }
  ...
  return (
    <>
      {!(fetchedStudentData && openCohorts.length > 0) ? (
        <div className="">
                    ...
                    <FormItem className="flex-1 space-y-1 relative">
                      ...
                      {fetchedStudentData?.isMobileVerified ? (
                        ...
                        <Button
                          ...
                          disabled={otpLoading}
                          onClick={() => handleVerifyClick(field.value || studentData?.mobileNumber)}
                          type="button"
                        >
