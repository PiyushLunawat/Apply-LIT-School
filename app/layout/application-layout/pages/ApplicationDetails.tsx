...
export const ApplicationDetails: React.FC = () => {
  return (
    <>
      <SubHeader
        subtitle="Welcome to LIT"
        submessage="Get started with your application process"
      />
      <img
        src="/assets/images/application-process-01.svg"
        alt="BANNER"
        className="w-screen object-left object-cover overflow-x-auto h-[188px] sm:h-full my-6 sm:my-12"
      />
