...
import { ArrowLeft, LoaderCircle, Pencil, X } from "lucide-react";
...
const TokenPaymentDialog: React.FC<TokenPaymentDialogProps> = ({
  open,
  setOpen,
  cohortId,
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="max-h-[90vh] overflow-y-auto max-w-[90vw] sm:max-w-xl mx-auto space-y-6 sm:space-y-9 bg-[#09090b] rounded-lg px-8 py-12 sm:py-16 text-center shadow-[0px_4px_32px_0px_rgba(0,0,0,0.75)]">
          <div className="space-y-6">
            <div className="flex justify-center">
              <img
                src="/assets/images/lit-cash-icon.svg"
                className="sm:w-[60px]"
              />
            </div>
            <div className="space-y-1">
              <div className="text-sm sm:text-base font-medium ">STEP 01</div>
          ...
          <RadioGroup
            ...
            onValueChange={(value) =>
              setSelectedPayment(value as "cash" | "bank transfer")
            }
          >
            <div className="flex flex-col gap-2">
              ...
              <div className="text-sm sm:text-base text-muted-foreground text-start">
                You may make a cash payment in person, following which you will
                receive a receipt. On uploading a soft copy of the receipt on
                the portal you will be able to access your dashboard.
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="text-sm sm:text-base text-muted-foreground text-start">
                You will be provided LIT School’s bank account details. You may
                make a NEFT transaction to the same account. Once you have made
                a transaction please upload an acknowledgement receipt.
              </div>
            </div>
          </RadioGroup>
      ...
      <Dialog open={secondDialogOpen} onOpenChange={setSecondDialogOpen}>
        ...
        <DialogContent className=" max-h-[100vh] !h-fit overflow-y-auto max-w-[100vw] sm:max-w-xl mx-auto space-y-6 bg-[#09090b] rounded-lg px-8 py-8 text-center shadow-[0px_4px_32px_0px_rgba(0,0,0,0.75)] h-[600px] overflow-hidden overflow-y-auto">
          <div>
            <ArrowLeft
              className="w-6 h-6 cursor-pointer absolute top-10 left-8"
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-1">
                <div className="text-sm sm:text-base font-medium ">STEP 02</div>
                <div className="text-2xl sm:text-3xl font-semibold">
              ...
              {selectedPayment === "cash" ? (
                <>
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="text-sm sm:text-base text-muted-foreground text-start">
                      Upload a soft copy of the acknowledgement receipt issued
                      to you by our fee manager to access your dashboard.
                    </div>
                  </div>
                </>
              ) : (
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex justify-start gap-2 mt-2 p-4 border border-[#2C2C2C] rounded-lg">
                      <div className="flex flex-col text-left">
                        <p className="flex gap-2 items-center text-sm sm:text-base font-medium">
                          <img
                            src="/assets/images/institute-icon.svg"
                            className="w-4 h-3"
                          />
                          Disruptive Edu Private Limited
                        </p>
                        <p className="text-xs sm:text-sm">
                          Account No.: 50200082405270
                        </p>
                        <p className="text-xs sm:text-sm">
            ...
            <div className="flex flex-col items-center">
              {receiptUrl ? (
                ...
                <label
                  ...
                  className="cursor-pointer flex flex-col items-center justify-center bg-[#64748B33] p-4 rounded-xl border-[#2C2C2C] w-full h-[200px] sm:h-[220px]"
                >
                  <div className="flex flex-col items-center space-y-3">
                    ...
                    {uploading ? (
                      ...
                      <p className="text-sm">
                        Upload your Acknowledgement Receipt
                      </p>
                    )}
                  </div>
                  <input
