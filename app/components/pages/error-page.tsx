    ...
    <Drawer>
      <div className="flex flex-col items-center justify-center h-screen text-center">
        <ReLink to="/" className="items-center space-x-2 flex">
          <img className="h-32" src="/assets/images/lit-logo.svg" alt="The LIT School" />
        </ReLink>
        <div className="mb-2">
          {code === 500 ? (
            <>
              ...
              <p className="text-muted-foreground">If this issue persist please contact our support team.</p>
              <div className="mt-4 text-center">
                <p className="text-muted-foreground mb-3">
                  You can also try going <Link className='text-white underline underline-offset-1' to="javascript: history.back();">back</Link> to where you were or go to our{' '}
                  <Link className='text-white underline underline-offset-1' to="/">home page</Link>
                </p>
              </div>
            </>
          ) : (
            <>
              ...
              <div className="mt-4 text-center">
                <p className="text-muted-foreground mb-3">
                  Try going <Link className='text-white underline underline-offset-1' to="javascript: history.back();">back</Link> where you were or go to our <Link to="/">home page</Link>
                </p>
              </div>
            </>
          )}
