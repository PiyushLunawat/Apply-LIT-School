  ...
  return (
    ...
    <div className={`relative bg-[#09090b] border border-[#2C2C2C] text-white p-6 sm:p-8 rounded-2xl w-full max-w-[1216px] mx-auto ${status==='rejected' ? ' shadow-[0px_4px_32px_rgba(0,163,255,0.2)]' : 'shadow-[0px_4px_32px_rgba(255,80,61,0.2)]'}`}>
      ...
      <div className="flex justify-between items-center mb-8">
        <div className="text-xl sm:text-3xl font-semibold">Application Review</div>
        <div className="text-sm sm:text-base">{date}</div>
      </div>

      <div className='text-base mb-8'>Your application was not accepted due to Lorem ipsum dolor sit amet. Quo rerum quia sit fuga voluptas eos similique nesciunt est maxime libero</div>

      <div className="flex items-center justify-between bg-[#2C2C2C] p-1.5 rounded-xl mb-6">
        <div className="flex items-center">
          <Button className="bg-[#09090b] p-2 w-[52px] h-[52px] rounded-xl mr-2">
            <File className=''/>
          </Button>
          <span>{fileName}</span>
        </div>
        <Button  className="bg-[#09090b] p-2 h-[52px] w-[52px] rounded-xl ">
