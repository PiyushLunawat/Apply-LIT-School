...
export const SignUpForm: React.FC<SignUpFormProps> = ({ setShowOtp }) => {
  ...
  return (
    <div className="flex flex-col gap-4 mt-8">
              ...
              <div className="flex flex-col sm:flex-row gap-2 ">
                <div className='flex-1 space-y-1 space-y-1'>
              ...
              <div className='flex-1 space-y-1'>
                ...
                <Label htmlFor="form-alert" className='flex gap-1 items-center text-sm text-[#00A3FF] font-normal pl-3 mt-1'>Your application form will be in line wih the course of your choice.</Label>
              </div>

              <Label htmlFor="form-error" className='flex gap-1 items-center text-sm text-[#FF503D] font-normal pl-3 mt-4'><AlertCircle className='w-3 h-3'/>All fields are mandatory. Please fill them up to proceed.</Label>
